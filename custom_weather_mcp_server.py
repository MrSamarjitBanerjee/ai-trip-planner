...
def _request_json(
    ...
    """Calling OpenWeather and turning failures into readable errors."""
    try:
...
def get_current_weather(
    ...
    """Returning current conditions for a city."""
...
def get_forecast(
    ...
    """Returning the next five three-hour forecast entries."""
